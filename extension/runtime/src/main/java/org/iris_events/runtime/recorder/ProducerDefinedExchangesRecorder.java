...
public class ProducerDefinedExchangesRecorder {
    ...
    public void registerProducerDefinedExchange(final BeanContainer beanContainer, final String exchange,
            final ExchangeType exchangeType, final Scope scope) {
        beanContainer.beanInstance(ProducedEventExchangeInitializer.class).addProducerDefinedExchange(exchange, exchangeType,
                scope);
    }
}
