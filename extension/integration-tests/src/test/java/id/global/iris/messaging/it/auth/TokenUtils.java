 ...
 * Source: Quarkus - SmallRye JWT - Deployment
 */
public class TokenUtils {
    ...
    public static String generateTokenString(PrivateKey pk, String kid, String jsonResName, Set<InvalidClaims> invalidClaims,
        ...
        //        final var encrypt = claims.innerSign(pk).encrypt();
        //        return encrypt;
        ...
        if (invalidClaims.contains(InvalidClaims.ALG)) {
            ...
            return jws.innerSign(sk).encrypt();
        } else {
            return pk == null ? jws.sign() : jws.innerSign(pk).encrypt();
        }
    }
