...
/**
 * Amqp consumable event. Events annotated with this annotation should be used as a parameter in a {@link MessageHandler}
 * annotated method.
 */
...
public @interface ConsumedEvent {
    ...
    /**
     * Whether the event is intended for internal system communication or for external communication i.e. an event to a
     * api-gateway that gets passed to a frontend client via websocket or rest response.
