...
import id.global.asyncapi.spec.annotations.bindings.message.AmqpBindings;
import id.global.asyncapi.spec.annotations.bindings.message.HttpBindings;
import id.global.asyncapi.spec.annotations.bindings.message.KafkaBindings;
import id.global.asyncapi.spec.annotations.bindings.message.MqttBindings;
