...
public class ServerException extends MessagingException {
    ...
    public ServerException(final IMessagingError messageError, final String message, boolean notifyFrontend) {
        super(messageError, message);
        this.notifyFrontend = notifyFrontend;
    }

    public ServerException(final IMessagingError messageError, final String message, final Throwable cause,
